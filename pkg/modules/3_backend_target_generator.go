...
type BackendTargetGenerator interface {
	Generate(registry *jsonschema.Registry, entrypointMessage pgs.Message) any
}
...
func (g *MultiDraftGenerator) Generate(registry *jsonschema.Registry, entrypointMessage pgs.Message) any {
